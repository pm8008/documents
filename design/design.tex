...
\begin{figure}[hp]
	\begin{adjustbox}
		{addcode={\begin{minipage}{\width}}
					...
					\end{minipage}}
			,center}
		\fbox{\includegraphics[max size={\textwidth}{\textheight}]{images/ui_design/login_screen.png}}
	\end{adjustbox}
\end{figure}
\newpage
	...
	\begin{figure}
		\begin{adjustbox}
			{addcode={\begin{minipage}{\width}}
						...
						\end{minipage}}
				,center}
			\fbox{\includegraphics[max size={\textwidth}{\textheight}]{images/ui_design/Main/0.png}}
		\end{adjustbox}
	\end{figure}
\end{center}
\newpage
...
\begin{center}
	\begin{figure}
		\begin{adjustbox}
			{addcode={\begin{minipage}{\width}}
							{\caption{%
								Add/configure diagram screen
							}
							\label{fig:mockup_config}
						\end{minipage}}
				,center}
			\fbox{\includegraphics[max size={\textwidth}{\textheight}]{images/ui_design/Main/1.png}}
		\end{adjustbox}
	\end{figure}
\end{center}
\newpage
...
\autoref{fig:gui_overview} illustrates the whole GUI structure of the application after the user has successfully logged in.
\\
\begin{figure}
	\begin{adjustbox}
		{addcode={\begin{minipage}{\width}}
...
\begin{figure}
	...
	\caption{The classes involed in the initialization setup}
\end{figure}
...
\begin{itemize}
	...
	\item[•]MongoConsumer
	      ...
	      \begin{figure}
		      ...
		      \caption{The classes involed in reading and writing data into the database}
	      \end{figure}
	...
	\item[•] NumberOfConnectionsPerNodePerSecond
	      ...
	      \begin{figure}
		      ...
		      \caption{The classes involed in the communication between the server and the client}
	      \end{figure}
...
\subsubsection{Sequence Diagram}
The following diagram show the initalization sequence order, the correspoding class diagram is \autoref{fig:class_back_end_init}, the program dependes on a couple of services namely (in order),the zookeper serivce, the kafka server service and the mongoDB service. Once all services are up and running the MongoConsumer is created and can start consuming messages and the Hub can start listening to client logins, requests, etc.
\begin{figure}
