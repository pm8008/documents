...
\begin{figure}
	\begin{adjustbox}
		{addcode={\begin{minipage}{\width}}
					...
					\end{minipage}},rotate=90,center}
		\includegraphics[max size={\textheight}{\textwidth}]{frontend/componentDefs.png}%
	\end{adjustbox}
\end{figure}
...
\begin{figure}
	\begin{adjustbox}
		{addcode={\begin{minipage}{\width}}
					...
					\end{minipage}}}
		\includegraphics[max size={\textwidth}{\textheight}]{frontend/stateStoresAndActions.png}%
	\end{adjustbox}
\end{figure}
...
\begin{figure}
	\begin{adjustbox}
		{addcode={\begin{minipage}{\width}}
					...
					\end{minipage}}}
		\includegraphics[max size={\textwidth}{\textheight}]{frontend/typeDefs.png}%
	\end{adjustbox}
\end{figure}
