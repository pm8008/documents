...
\item{getCollection(String coll)}
\item{getCollectionInRange(key, start, end)}
\item{getCollectionInRangeSize(key, start, end)}
\end{itemize}

Messages from server to client:
\begin{itemize}
\item{ist of collections: String[]}
\item{collection size: long}
\item{data set: String[]  // array of json records}
\end{itemize}
