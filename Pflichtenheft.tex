...
Line chart: to easily compare ,linearly, two variables from a data stream.
\\
...
~\\
Raster spike diagram: this is useful to show the transmission window of each packet and it's corresponding partner.
\\
Scatter plot: a way to visualize up to 4 dimensions of the data stream.
\\
