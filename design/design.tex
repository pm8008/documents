...
The diagram on the next page shows an overview of GUI elements of the main application, when the user has successfully logged in.
\newpage

\begin{figure}
	\includegraphics[angle=90,origin=c,max size={\textheight}{\textwidth}]{frontend/overview.png}
\end{figure}
