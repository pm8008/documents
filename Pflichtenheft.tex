...
\\
int he previous section we took a look at the Main window and it's different sections, there we described that filters that apply to every diagram are shown at all times shown as item 2. But what about when you want to create a filter that only affects one diagram?
\\
...
%spike raster plot
%https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3306002/pdf/fnsys-06-00006.pdf
%network graph
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth/2 ]{Images/line_chart.png}
	\caption{Line chart example}
	\label{fig:linechart}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth/2]{Images/net_diag.png}
	\caption{Network diagram example}
	\label{fig:netdiaram}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth/2]{Images/Scatter_diagram.png}
...
\begin{figure}[h]
	\centering
	\label{fig:mainWindow4}
	\includegraphics[width=\textwidth/2]{Images/spike_raster_plot.png}
	\caption{Spike raster plot example}
